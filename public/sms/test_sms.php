<?php
 ...
 $username="dmmalda-pnrd"; //username of the department
 $password="Pnrd@12345#"; //password of the department
 $senderid="DMMLDA"; //senderid of the deparment
 $message=$Message; //message content
 $messageUnicode="मोबाइलसेवामेंआपकास्वागतहै "; //message content in unicode
 $mobileno=$mobile_no; //if single sms need to be send use mobileno keyword
 ...
 $deptSecureKey= "3c8111e1-cafd-472a-bf39-6bee03f6f83c"; //departsecure key for encryption of message...
